<%@ Page Title="" Language="C#" MasterPageFile="~/Homepage.Master" AutoEventWireup="true" CodeBehind="UserRegister.aspx.cs" Inherits="JOBPortal.UserRegister" %>
                  ...
                  <div class="form-contact contact_form" id="contactForm">
                        ...
                        <div class="form-group mt-3">
                            <asp:Button ID="Button1" runat="server"  Class="login-btn" Text="Sign Up" OnClick="Button1_Click"/>
                             <div class="center">Already Have an Account?--> <a href="UserLogin.aspx">Sign In</a></div>
                                           </div>
                    </div>
