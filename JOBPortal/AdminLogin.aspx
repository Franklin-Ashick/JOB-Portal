<%@ Page Title="" Language="C#" MasterPageFile="~/Homepage.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="AdminLogin.aspx.cs" Inherits="JOBPortal.AdminLogin" %>
                        ...
                        <div class="login-form">
                            <div class="row">
                                <form id="contactForm" method="POST" action="http://rockstheme.com/rocks/aievari-live/contact.php" class="log-form">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="clear"></div>
                                        <div class="separetor"><span>Or  Sign</span></div>
                                        <div class="sign-icon">
                                           

                                            <div class="center"><a href="UserLogin.aspx">UserLogin</a>     or     <a href="RecruiterLogin.aspx">RecruiterLogin</a>     </div>
                                        </div>
                                    </div>
                                </form>
                            </div>
