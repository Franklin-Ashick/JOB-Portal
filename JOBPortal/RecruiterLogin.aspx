<%@ Page Title="" Language="C#" MasterPageFile="~/Homepage.Master" AutoEventWireup="true"  EnableEventValidation="false" CodeBehind="RecruiterLogin.aspx.cs" Inherits="JOBPortal.RecruiterLogin" %>
                                ...
                                <form id="contactForm" method="POST" action="http://rockstheme.com/rocks/aievari-live/contact.php" class="log-form">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="sign-icon">
                                            ...
                                            <div class="acc-not">Don't have an account  <a href="RecruiterRegister.aspx">Sign up</a></div>
