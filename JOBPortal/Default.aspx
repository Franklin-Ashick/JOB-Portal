<%@ Page Title="" Language="C#" MasterPageFile="~/Homepage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="JOBPortal.Default" %>
				              	...
				              	<form action="#" class="search-job">
				              		<div class="row no-gutters">
				              			...
				              			<div class="col-md">
				              				<div class="form-group">
				              					<div class="form-field">
								                	<button type="submit" class="form-control btn btn-primary" onclick="">Search</button>
									              </div>
								              </div>
				              			</div>
				              		</div>
          ...
          <div class="row d-flex justify-content-center">
            <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
              ...
              <div class="row d-flex justify-content-center mt-4 mb-4">
               <div class="col-md-12">
				   <form onclick="alert('Subscribed\nThank You')" class="subscribe-form">
